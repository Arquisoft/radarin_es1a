...
|2|Efficiency|The user wants to know which friends are nearby while he is in the area|The position of friends on the map and the search of new friends is updated every 3 seconds and the send of the position of the user to the database every 30 seconds. | Very high, Very high
